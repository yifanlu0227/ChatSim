...
public:
  ...
  BoundedRays RaysFromPose_wide_angle(const Tensor& pose, int reso_level = 1);
  ...
  Rays Img2WorldRay_wide_angle(int cam_idx, const Tensor& ij);
  Rays Img2WorldRay_wide_angle(const Tensor& pose, const Tensor& intri, const Tensor& dist_params, const Tensor& ij);
