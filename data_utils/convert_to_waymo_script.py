...
if __name__ == '__main__':
    ...
    parser.add_argument("-c", "--calibration_tool", type = str, help="select colmap or metashape")
    ...
    for file_name in file_list:
        if file_name not in scene_list:
            continue
        os.system('python convert_to_waymo.py -d {} -c {}'.format(os.path.join(args.datadir, file_name), args.calibration_tool))
